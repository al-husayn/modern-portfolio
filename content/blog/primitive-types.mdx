...
<CardGroup cols={2}>
  <Card title="Primitives vs Objects" icon="clone" href="/content/primitives-objects">
    How primitives and objects behave differently in JavaScript
  </Card>
  <Card title="Type Coercion" icon="shuffle" href="/content/type-coercion">
    How JavaScript converts between types automatically
  </Card>
  <Card title="== vs === vs typeof" icon="equals" href="/content/equality-operators">
    Understanding equality operators and type checking
  </Card>
  <Card title="Scope & Closures" icon="layer-group" href="/content/scope-and-closures">
...
<CardGroup cols={2}>
  ...
  <Card title="How numbers are encoded in JavaScript" icon="newspaper" href="https://2ality.com/2012/04/number-encoding.html">
