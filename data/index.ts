export const DATA = {
  ...
  home: {
    ...
    skills: {
      ...
      sectionDescription: 'I deliver modern, reliable web solutions tailored to your needs',
      services: [
        {
          ...
          description: 'Fast, responsive apps built with React, Next.js, and Tailwind CSS.',
        },
        {
          name: 'Full-Stack Development',
          icon: 'lucide:layers-3',
          logo: 'https://uxwing.com/wp-content/themes/uxwing/download/arts-graphic-shapes/full-stack-developer-icon.svg',
          description: 'End-to-end solutions with Node.js backend and modern frontend.',
        },
        {
          ...
          description: 'SEO-friendly landing pages and marketing sites with optimized performance.',
        },
        {
        ...
        },
        {
          ...
          description: "Expert guidance and code reviews to ensure your project's success.",
        },
        {
          name: 'WordPress Development',
          icon: 'simple-icons:wordpress',
          logo: 'https://s.w.org/style/images/about/WordPress-logotype-wmark.png',
          description: 'Professional themes and plugins with performance and SEO focus.',
        },
      ],
    },
    testimonials: {
  ...
  about: {
    profile: {
      ...
      image: 'https://al-drake.netlify.app/static/media/profile.211cb621e39afe112f2a.png',
      description: [
  ...
  projects: {
    ...
    work: [
      ...
      },
      {
        ...
        github: 'https://github.com/al-husayn/blog',
        live: 'https://blog.al-husayn.dev/',
        tech: [
          { name: 'React', icon: 'logos:react' },
          { name: 'TailwindCSS', icon: 'logos:tailwindcss-icon' },
          { name: 'TypeScript', icon: 'logos:typescript-icon' },
      ...
      },
      {
        ...
        category: 'Web Development',
        details:
          'A responsive personal portfolio built with Next.js, TypeScript, Tailwind CSS, HeroUI, Framer Motion, and EmailJS. It features animated page sections, project filtering, project detail modals, a contact form, theme switching, and a data-driven content structure for easy updates.',
        github: 'https://github.com/al-husayn/modern-portfolio',
        live: 'https://www.al-husayn.dev/',
        tech: [
          { name: 'React', icon: 'logos:react' },
          { name: 'TailwindCSS', icon: 'logos:tailwindcss-icon' },
          { name: 'TypeScript', icon: 'logos:typescript-icon' },
          { name: 'Nextjs', icon: 'skill-icons:nextjs-dark' },
          { name: 'HeroUI', icon: 'simple-icons:heroui' },
          { name: 'Framer Motion', icon: 'simple-icons:framer' },
          { name: 'EmailJS', icon: 'simple-icons:maildotru' },
          { name: 'Vercel', icon: 'simple-icons:vercel' },
        ],
      },
  ...
  blog: {
    ...
    intro: 'Guides, references, and tutorials on programming, web development, and design.',
  },
  navigation: [
